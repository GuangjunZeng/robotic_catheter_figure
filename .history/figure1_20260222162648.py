...
def main():
    ...
    plotter.add_mesh(x_axis, color="black", line_width=2)
    plotter.add_mesh(y_axis, color="black", line_width=2)
    plotter.add_point_labels(
        [axis_origin], ["O"], font_size=10, text_color="black", show_points=False)
    plotter.add_point_labels([[axis_origin[0] + axis_length, axis_origin[1], z_obs]], [
                             "X"], font_size=10, text_color="black", show_points=False)
    plotter.add_point_labels([[axis_origin[0], axis_origin[1] + axis_length, z_obs]], [
                             "Y"], font_size=10, text_color="black", show_points=False)
