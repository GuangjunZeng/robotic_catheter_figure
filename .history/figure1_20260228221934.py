...
def main():
    ...
    # 起点 P0 在 [0.5, 0.0, 0.85]，位于 XOZ 平面上 (y=0)，且 Z 轴上移 0.35
    catheter_points = np.array([
        [0.5, 0.0, 0.85],   # P0: 起点 (Z: 0.5 + 0.35 = 0.85)
        [0.5, 0.8, 0.85],   # P1: 沿 +y 方向垂直伸出 (Z: 0.5 + 0.35 = 0.85)
        [1.2, 1.8, 1.55],   # P2: 向 +x, +y, +z 方向平滑过渡 (Z: 1.2 + 0.35 = 1.55)
        [2.0, 2.2, 2.85]    # P3: 末端 (Z: 2.5 + 0.35 = 2.85)
    ])
    cat_radius = 0.04
    ...
    # 中心点 Z 轴同步上移 0.35
    grid_size = 1.0
    base_plane = pv.Plane(center=[0.5, 0.0, 0.85], direction=[0, 1, 0],
