...
def main():
    ...
    # 起点 P0 在 [0.5, 0.0, 0.7]，位于 XOZ 平面上 (y=0)，且 Z 轴上移 0.2 (0.85 - 0.15 = 0.7)
    catheter_points = np.array([
        [0.5, 0.0, 0.7],    # P0: 起点 (Z: 0.85 - 0.15 = 0.7)
        [0.6, 0.8, 0.9],    # P1: 沿 +y 方向垂直伸出 (Z: 0.85 - 0.15 = 0.7)
        [0.9, 1.5, 1.5],    # P2: 向 +x, +y, +z 方向平滑过渡 (Z: 1.55 - 0.15 = 1.4)
        [1.7, 2.05, 2.4]     # P3: 末端 (Z: 2.85 - 0.15 = 2.7)
    ])
    cat_radius = 0.04
    ...
    # 中心点 Z 轴同步下移 0.15
    grid_size = 1.0
    base_plane = pv.Plane(center=[0.5, 0.0, 0.7], direction=[0, 1, 0],
