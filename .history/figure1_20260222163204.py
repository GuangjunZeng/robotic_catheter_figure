...
def main():
    ...
    # 添加箭头尖端
    x_tip = pv.Cone(center=[axis_origin[0] + axis_length, axis_origin[1], z_obs],
                    direction=[1, 0, 0], height=0.015, radius=0.006, resolution=20)
    y_tip = pv.Cone(center=[axis_origin[0], axis_origin[1] + axis_length, z_obs],
                    direction=[0, 1, 0], height=0.015, radius=0.006, resolution=20)
