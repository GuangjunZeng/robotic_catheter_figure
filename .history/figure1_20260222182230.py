...
def main():
    ...
    def add_2d_velocity(plotter, center, direction, size=0.06, gap=0.025):
        ...
        tip_size = size * 0.28
        tip1 = pv.Line(end_pt - d * tip_size + perp * tip_size, end_pt)
        tip2 = pv.Line(end_pt - d * tip_size - perp * tip_size, end_pt)
