...
def main():
    ...
    # --- 新增：起点固定球 (Fixed Point) ---
    # 在导管与平面的连接处添加一个小球，体现固定感
    fixed_point_sphere = pv.Sphere(radius=0.05, center=base_center)
    plotter.add_mesh(fixed_point_sphere, color="#666666",
    ...
    for i, pos in enumerate(box_pos):
        ...
        b.rotate_x(30, inplace=True)  # 绕 X 轴自转 20 度
